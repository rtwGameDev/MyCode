...
struct dateTime {
	...
	string minute;
	dateTime() {}
	dateTime(string day, string month, string year, string hour, string minute) {
		this->day = day;
		this->month = month;
		this->year = year;
		this->hour = hour;
...
bool checkDATE(dateTime date_time) {
...
long long checkTimeBefore(dateTime date_time) {
	Format(date_time);
...
// true => o tuong lai
// false => o qua khu
bool past_future(dateTime date_time) {
	Format(date_time);
